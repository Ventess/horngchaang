...
$(document).ready(function() {   
	...
	*/
	...
	if( use_redirect=='Y' && mode =='w' && (ua.match("iphone") || ua.match("ipod") || ua.match("android")|| ua.match("symbianos")|| ua.match("ios") || ua.match("blackberry"))){
	...
	function gotoMOB(i){	
		if (ua.match("iphone") || ua.match("ipod") || ua.match("android")|| ua.match("symbianos")|| ua.match("ios") || ua.match("blackberry")){
...
function init() { 
 if(document.getElementById("innermainContent")&& document.getElementById("sidebar") ){
	 ...
	 console.log( document.getElementById("innermainContent").clientHeight +' '+ document.getElementById("sidebar").clientHeight);
...
$(document).ready(function(){
  // 公司介紹地圖
	...
	//console.log($('.Content-body').width());
    //$('.Content-body img').css({"max-width":$('.Content-body').width()+"px","height":"auto"}); 
...
//$("head").append($("<link rel='stylesheet' href='../skin/fbs.css' type='text/css' media='screen' />"));
/*
#sidebar{display:none;} 
body{background-color:#FFFFF;background:none;}
#Tbody,#header,#container,#header,#innermainContent{width:780px;}
*/
